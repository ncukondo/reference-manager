...
- [ ] **15.1.1**: Update McpContext interface
...
- [ ] **15.1.2**: Update createMcpContext implementation
  - File: `src/mcp/context.ts`
...
- [ ] **15.2.1**: Update createMcpServer function
...
- [ ] **15.2.2**: Update registerAllTools signature
...
- [ ] **15.2.3**: Update registerAllResources signature
...
- [ ] **15.4.1**: Update library resources
...
- [ ] **15.5.1**: Run all tests and quality checks
